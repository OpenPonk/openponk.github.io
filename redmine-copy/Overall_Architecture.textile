h1. Overall Architecture

h2. DC / Spec / Roassal composition
...
!file://figures/Models.png!:file://figures/Models.png
...
!file://figures/Events.png!:file://figures/Events.png
...
!{width:90%}file://figures/All%20layers%20simplified.png!:file://figures/All%20layers%20simplified.png

More complex and chaotic model of interactions between model, controllers, gui, roassal and trachel.
!file://figures/Architecture%20layers.png!:file://figures/Architecture%20layers.png

h3. View (Roassal)

DynaCASE uses Roassal2 from "Moose project":http://www.moosetechnology.org/
Roassal (and Trachel) is well documented at "http://agilevisualization.com/":http://agilevisualization.com/#book
